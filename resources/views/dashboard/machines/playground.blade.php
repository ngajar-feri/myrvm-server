...
@section('title', 'MyRVM Playground - ' . $machine->name)
...
<div class="playground-container" data-machine-id="{{ $machine->id }}">
    ...
    <header class="playground-header">
        ...
        <div class="header-right">
            ...
            <button class="btn-exit-maintenance" id="btnExitMaintenance">
                ...
                <div class="panel-body">
                    ...
                    <div class="image-list-container">
                        ...
                        <div class="image-list" id="imageList">
                            <div class="image-list-empty">No images uploaded yet</div>
                        </div>
                    </div>
                </div>
            </div>
